...
This package contains implementations of the ComparisonAgent interface which is
responsible for comparing iterations and explaining changes in rankings.
"""
...
__all__ = ["ComparisonAgent", "StandardComparisonAgent"]
