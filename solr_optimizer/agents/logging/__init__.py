...
This package contains implementations of the LoggingAgent interface which is
responsible for recording experiment iterations, configurations, and results.
"""
